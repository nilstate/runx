...
| Cloud packages (`cloud/packages/api`, `worker`, `auth`, `receipts-store`) | Import validators/types/OpenAPI builders from `@runxhq/contracts` | No direct hash pin found | Continue through `@runxhq/contracts`; OpenAPI remains generated from the package schema exports. |
