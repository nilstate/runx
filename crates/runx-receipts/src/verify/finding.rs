...
pub enum ReceiptFindingCode {
    ...
    ReceiptPaidBindingMissing,
    ReceiptEvidenceClassInvalid,
    DuplicateReceiptEvidence,
    InnerReceiptParentBindingMissing,
    InnerReceiptClassMismatch,
    InnerReceiptBindingMismatch,
    InnerReceiptParentInvocationMismatch,
    InnerReceiptParentDigestMismatch,
    InnerReceiptLineageConflict,
    SealDigestMismatch,
