...
use crate::{
    ...
    ExternalAdapterResponse, ExternalJobContinuation, ExternalJobSchedule,
    ExternalJobScheduleIntent, ExternalJobStageRequest, ExternalJobStageResult,
    ExternalReceiptVerification, Fixture, GetPaidInvocationRequest, GetPaidInvocationResult,
    GitBlobDigest, HandoffSignal, HandoffState, LedgerEntry, LocalArtifact, LocalArtifactPage,
    OfferRevisionRef, OperationalPolicy, OperationalProposal, OrchestratorExecutionContext,
    OrchestratorHandoffContext, Output, PacketIndex, PaidInvocation, PaidSkillListing,
...
pub fn generated_schema_artifacts() -> Vec<SchemaArtifact> {
    vec![
        ...
        public_packet_artifact::<ExternalReceiptVerification>(
        ...
        public_packet_artifact::<Signal>("signal.schema.json"),
        schema_artifact::<SourcePacket>("source-packet.schema.json"),
        public_packet_artifact::<Decision>("decision.schema.json"),
        schema_artifact::<Act>("act.schema.json"),
        schema_artifact::<Verification>("verification.schema.json"),
        public_packet_artifact::<Receipt>("receipt.schema.json"),
        ...
        public_packet_artifact::<OperationalPolicy>("operational-policy.schema.json"),
        ...
        public_packet_artifact::<ExternalJobScheduleIntent>(
            "external-job-schedule-intent.schema.json",
        ),
        public_packet_artifact::<ExternalJobStageRequest>("external-job-stage-request.schema.json"),
        public_packet_artifact::<ExternalJobStageResult>("external-job-stage-result.schema.json"),
