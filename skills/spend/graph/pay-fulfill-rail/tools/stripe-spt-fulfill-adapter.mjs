...
// Registry-installed skills do not install npm dependencies. Keep this protocol
// endpoint self-contained until the Stripe SPT provider is resolved through a
// configured hosted adapter; it is not a reusable protocol owner.
