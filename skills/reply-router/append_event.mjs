// reply-router · append_suppression step
// When the classify step routes to "suppress", this step commits a
// recipient-keyed suppression event to data-store via an ungated CAS
// append_event. The durable record is the compliance block the next send-as
// preflight reads as a fail-closed block.
...
// Idempotency key is deterministic over receipt id, recipient, and reply content.
