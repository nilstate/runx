...
- `X.yaml` includes the two required inline harness cases: `in_grant_charter_recommends` and `out_of_grant_charter_blocks`; the out-of-grant case expects `needs_agent`.
