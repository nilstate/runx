...
Project: fixture-transitive-vulnerable-app
Project URL: https://example.com/fixture-transitive-vulnerable-app
Lockfile source: fixtures/package-lock-transitive-advisory.json
Ecosystem: npm
...
- minimist@0.0.8: GHSA-vh95-rmgr-6w4m, severity critical, fix 0.2.1, direct dependency to bump mkdirp, evidence https://osv.dev/vulnerability/GHSA-vh95-rmgr-6w4m
  - Fix path: Bump mkdirp so minimist@0.0.8 is replaced by a non-vulnerable version; OSV first fixed version: 0.2.1.
