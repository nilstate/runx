...
export function validateCredentialEnvelope(
  ...
  const envelope = validateCredentialEnvelopeContract(value, label);
  return {
    ...
    grant_reference: envelope.grant_reference === undefined
      ? undefined
      : {
        grant_id: envelope.grant_reference.grant_id,
        scope_family: envelope.grant_reference.scope_family,
        authority_kind: envelope.grant_reference.authority_kind,
        target_repo: envelope.grant_reference.target_repo,
        target_locator: envelope.grant_reference.target_locator,
      },
    material_ref: envelope.material_ref,
  };
}
