...
export function writeUsage(stream: Writable, env: NodeJS.ProcessEnv = process.env): void {
  ...
  stream.write(
    [
      ...
      "  runx docs doctor [--sourcey-root .] [--json]",
      "  runx docs dogfood [--sourcey-root .] [--json]",
      "  runx docs status --issue owner/repo#issue/123 [--json]",
      "  runx docs bind-repo --issue owner/repo#issue/123 --repo-root ../target-repo [--sourcey-root .] [--json]",
      ...
      "  runx doctor",
      "  runx docs doctor",
      "  runx docs status --issue sourcey/sourcey.com#issue/2",
      "  runx docs bind-repo --issue sourcey/sourcey.com#issue/2 --repo-root ../easyllm",
      "  runx dev",
