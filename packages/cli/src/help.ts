...
export function writeUsage(stream: Writable, env: NodeJS.ProcessEnv = process.env): void {
  ...
  stream.write(
    [
      ...
      "  runx add <registry-ref> [--version version] [--to skills-dir] [--registry url] [--digest sha256] [--json]",
      "  runx add <github-url> [--version git-ref] [--registry api-url] [--json]",
      ...
      "  runx list",
      "  runx doctor",
      "  runx skill ./skills/local-operator --runner health-check",
      "  runx skill ./skills/local-operator --runner reconcile --issue owner/repo#issue/2",
      "  runx dev",
